...
// Handle Join/Create - Only redirect ONCE after the POST is processed
...
// Fetch current state without redirecting
    ...
    <?php else: ?>
        <nav>
            ...
            <div style="margin-left:auto; display:flex; gap:15px; align-items:center;">
                ...
                <a href="actions.php?do=leave" style="color:var(--error); text-decoration:none; font-weight:bold; font-size:0.8rem;">LEAVE</a>
            </div>
        </nav>
                        ...
                        <?php foreach($pdo->query("SELECT * FROM characters ORDER BY RANDOM() LIMIT 3") as $c): ?>
                            <label class="item-card">
                                ...
                                <?php if(!empty($c['image_url'])): ?>
                                    <img src="<?= htmlspecialchars($c['image_url']) ?>" style="width:100%; border-radius:5px; margin-bottom:5px;">
                                <?php endif; ?>
                ...
                <?php foreach($players as $p): ?>
                    <div class="item-card">
                        ...
                        <?php if(!empty($p['c_img'])): ?>
                            <img src="<?= htmlspecialchars($p['c_img']) ?>" style="width:100%; border-radius:8px; margin:10px 0;">
                        <?php endif; ?>
